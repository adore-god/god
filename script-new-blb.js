  ...
  mainEl.addEventListener("mouseover", async function(e) {
    ...
    try {
      ...
      tooltip.innerHTML = data.text 
        ? `<span style="font-weight:bold;">${data.reference}</span><br>${data.text}<br><div style="border:0;border-top:1px solid #000;margin:8px 0;"></div><a href="${blbLink}" target="_blank" style="color:#82adff !important;text-decoration:none;font-weight:bold;">View on Blue Letter Bible →</a>` 
        : "Not found";
    } catch {
